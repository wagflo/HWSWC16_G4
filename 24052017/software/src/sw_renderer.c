...
rtSetCamera (vec3_t *lookfrom, vec3_t *lookat, fix16_t vfov)
{
	...
	//write the origin
	IOWR(MM_INTERFACE_TEST_0_BASE, 0x3011, camera.origin.x[0]);
	IOWR(MM_INTERFACE_TEST_0_BASE, 0x3012, camera.origin.x[1]);
	IOWR(MM_INTERFACE_TEST_0_BASE, 0x3013, camera.origin.x[2]);
	//write the horizontal add
	IOWR(MM_INTERFACE_TEST_0_BASE, 0x3031, camera.horizontal.x[0]);
	IOWR(MM_INTERFACE_TEST_0_BASE, 0x3032, camera.horizontal.x[1]);
	IOWR(MM_INTERFACE_TEST_0_BASE, 0x3033, camera.horizontal.x[2]);
	//write the vertical add
	IOWR(MM_INTERFACE_TEST_0_BASE, 0x3041, camera.vertical.x[0]);
	IOWR(MM_INTERFACE_TEST_0_BASE, 0x3042, camera.vertical.x[1]);
	IOWR(MM_INTERFACE_TEST_0_BASE, 0x3043, camera.vertical.x[2]);
	//write the addition base
	IOWR(MM_INTERFACE_TEST_0_BASE, 0x3021, camera_base.x[0]);
	IOWR(MM_INTERFACE_TEST_0_BASE, 0x3022, camera_base.x[1]);
	IOWR(MM_INTERFACE_TEST_0_BASE, 0x3023, camera_base.x[2]);
}
