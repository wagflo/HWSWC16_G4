...
sphere_t test1_spheres[3] = {
		{
			.center = { {FIX_FROM_FLOAT (0.8), FIX_FROM_FLOAT (0.0), FIX_FROM_FLOAT (0.0)} },
			.radius = FIX_FROM_FLOAT (0.5),
			.color  = { {FIX_FROM_FLOAT (1.0), FIX_FROM_FLOAT (0.0), FIX_FROM_FLOAT (0.0)} },
			.mat    = EMITTING
		},
		{
			.center = { {FIX_FROM_FLOAT (0.0), FIX_FROM_FLOAT (0.0), FIX_FROM_FLOAT (0.8)} },
			.radius = FIX_FROM_FLOAT (0.5),
			.color  = { {FIX_FROM_FLOAT (0.0), FIX_FROM_FLOAT (1.0), FIX_FROM_FLOAT (0.0)} },
			.mat    = EMITTING
		},
		{
			.center = { {FIX_FROM_FLOAT (0.0), FIX_FROM_FLOAT (0.0), FIX_FROM_FLOAT (-0.8)} },
			.radius = FIX_FROM_FLOAT (0.5),
			.color  = { {FIX_FROM_FLOAT (0.0), FIX_FROM_FLOAT (0.0), FIX_FROM_FLOAT (1.0)} },
			.mat    = EMITTING
		}
};
