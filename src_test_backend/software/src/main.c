...
main (void)
{
	...
	displayClear (0);
	uint8_t modulo = 0;
	uint32_t color_x = 0x00000000;
	uint32_t color_y = 0x00000000;
	uint32_t color_z = 0x00000000;
	while (1)
	{
	  if (start > 0) {
	  ...
	  IOWR(MM_INTERFACE_TEST_0_BASE, 0x0003, color_x);
	  IOWR(MM_INTERFACE_TEST_0_BASE, 0x0003, color_y);
	  IOWR(MM_INTERFACE_TEST_0_BASE, 0x0003, color_z);
